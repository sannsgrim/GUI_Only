...
public class Search_TextField extends JTextField {
    ...
    public Search_TextField() {
        ...
        iconSearch = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Resource/Images/search.png")));
        iconClose = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Resource/Images/close.png")));
        iconLoading = new ImageIcon(Objects.requireNonNull(getClass().getResource("/Resource/Images/loading.gif")));
    ...
    public void addEvent(SearchTextEvent event) {
        this.event = event;
    }
