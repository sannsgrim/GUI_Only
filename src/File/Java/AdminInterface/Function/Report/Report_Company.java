...
public class Report_Company extends JPanel {
    ...
    private void testData(String where, Object... search){
        try{
            ...
            String baseQuery = "SELECT companyInfo.companyNo, companyInfo.companyName, " +
                    "COALESCE(COUNT(callhistory.ticket), 0) AS TotalTickets " +
                    "FROM companyInfo " +
                    "LEFT JOIN callhistory ON companyInfo.companyName = callhistory.companyNames ";
            ...
            String finalQuery = baseQuery + timeQuery + "GROUP BY companyInfo.companyNo, companyInfo.companyName";
    ...
    public void initComponents(){
        ...
        JLabel lbTitle = new JLabel("Report Company");
        ...
        table.setModel(new DefaultTableModel(
                new Object[][]{},
                new String[]{
                        "Company No", "Company Name", "Total Tickets"}
        ){
